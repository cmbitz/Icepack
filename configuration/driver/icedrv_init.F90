...
! author Elizabeth C. Hunke, LANL
      ...
      use icedrv_restart_shared, only: runtype_startup,restart_type
      ...
      use icedrv_forcing, only: data_dir,ntime_atm,ntime_ocn
      ...
      namelist /setup_nml/ &
        ...
        conserv_check,  history_cdf,runtype_startup,restart_type,input_lat, &
        input_lon
      ...
      namelist /forcing_nml/ &
        ...
        data_dir,        trestore,        restore_ocn, ntime_atm, &
        ntime_ocn
      ...
      restart_type = 'bin'   ! restart file type: binary or netcdf
      restart_file = 'iced'  ! restart file name prefix
      input_lat    = p5*pi   ! input lat point
      input_lon    = c0 
...
! author: Elizabeth C. Hunke, LANL
      ...
      !TLON(:) = c0
      TLAT(:) = input_lat  ! namelist option for lat/lon
      TLON(:) = input_lon
      do i = 2, nx
